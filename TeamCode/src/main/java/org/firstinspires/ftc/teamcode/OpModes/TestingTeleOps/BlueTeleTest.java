...
public class BlueTeleTest extends OpMode {
    ...
    public void init() {
        ...
        flywheel = new FlywheelConstants(hardwareMap, follower, false);
    ...
    public void start() {
        ...
        follower.setStartingPose(new Pose(62.73, 8.22, Math.toRadians(180)));
        flywheel.enable();
    }
