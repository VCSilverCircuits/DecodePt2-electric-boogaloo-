...
@Autonomous(name = "Red Auto Shoot Ursa")
public class TurretAimTest extends OpMode {
    ...
    public void loop() {
        ...
        turret.aim(true);
        turret.updateOdometryDebug(true);
        ...
        telemetry.addData("Turret Current Deg", turret.getCurrentTurretAngleDeg());
        telemetry.addData("Odo Field Deg", turret.getDebugFieldAngleDeg());
        telemetry.addData("Odo Relative Deg", turret.getDebugRobotRelativeDeg());
        telemetry.addData("Odo Target Ticks", turret.getDebugTargetTicks());
        telemetry.addData("Vision tx", turret.getTx());
