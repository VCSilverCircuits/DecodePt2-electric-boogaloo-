...
@Autonomous(name = "Blue Weird Shoot")
public class NNBlueAuto extends OpMode {
    ...
    private final Pose startPose = new Pose(flipX(122.0187), 123.8131, Math.toRadians(flipHeading(48)));
    ...
    private final Pose intake1 = new Pose(flipX(124), 94, Math.toRadians(flipHeading(-8)));
